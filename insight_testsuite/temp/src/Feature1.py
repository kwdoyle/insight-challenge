...
# Initialize graph
with open('/users/kevin/documents/New Insight Challenge/digital-wallet/paymo_input/batch_payment.csv', 'rU') as f:
    read = csv.reader(f)
...
pickle.dump(graph, open('/users/kevin/documents/New Insight Challenge/digital-wallet/payment_graph.p', 'wb'))

# Check new payments for existing match pairs
with open('/users/kevin/documents/New Insight Challenge/digital-wallet/paymo_input/stream_payment.csv', 'rU') as f:
    read = csv.reader(f)
    count = 0
    for row in read:
